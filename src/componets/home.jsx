...
const GallerySection = () => {
  return (
    <div className="relative py-32 pb-60 px-4 bg-gradient-to-b from-secondary-600 to-secondary-700">
      ...
      <svg
        className="absolute -bottom-1 left-0 w-full rotate-180"
      ...
      <svg
        className="absolute -top-24 left-0 w-full rotate-180"
        viewBox="0 0 1440 120"
        preserveAspectRatio="none"
      >
        <path
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <span className="text-orange-400 font-bold tracking-wider mb-4 block">
            JOIN US TODAY
          </span>
